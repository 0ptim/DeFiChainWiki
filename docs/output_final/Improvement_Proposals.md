...
1.  That the incentive rewards of 100 DFI per block be sustained, with
...
The white paper laid out the initial block reward to be 200 DFI,
...
1.  Cycle period being 32,690 blocks (approx. 2 weeks). Every 32,690
